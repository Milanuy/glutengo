...
- El CTA flotante principal de la web publica debe priorizar "Registrar mi local" y llevar al formulario. Debe convivir con un banner flotante comercial mas chico para vender visibilidad, apuntando a la seccion de extras.
