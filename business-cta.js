(function(){
  ...
  style.textContent = [
    ...
    '@media(max-width:640px){#gg-business-cta{left:12px;right:12px;bottom:calc(12px + env(safe-area-inset-bottom));width:auto;border-radius:14px;padding:12px 46px 12px 14px;display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:10px;z-index:322}#gg-business-cta .gg-float-kicker{display:none}#gg-business-cta .gg-float-title{font-size:15px;line-height:1.08;margin:0;max-width:190px}#gg-business-cta .gg-float-copy{display:none}#gg-business-cta .gg-float-actions{justify-content:flex-end}#gg-business-cta .gg-float-link{min-width:156px;min-height:44px;padding:10px 20px;border-radius:12px;font-size:13px}#gg-business-cta .gg-float-muted{display:none}#gg-business-cta .gg-float-close{top:50%;right:10px;transform:translateY(-50%)}}',
    '@media(max-width:640px){#gg-visibility-cta{left:12px;right:12px;bottom:calc(88px + env(safe-area-inset-bottom));width:auto;border-radius:13px;padding:10px 44px 10px 12px;display:grid;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:10px;z-index:321}#gg-visibility-cta .gg-float-kicker,#gg-visibility-cta .gg-float-copy,#gg-visibility-cta .gg-float-muted{display:none}#gg-visibility-cta .gg-float-title{font-family:DM Sans,system-ui,sans-serif;font-size:13px;line-height:1.15;margin:0;max-width:180px}#gg-visibility-cta .gg-float-actions{justify-content:flex-end}#gg-visibility-cta .gg-float-link{min-width:122px;min-height:40px;padding:9px 14px;border-radius:11px;font-size:12px}#gg-visibility-cta .gg-float-close{top:50%;right:8px;transform:translateY(-50%);width:26px;height:26px}}'
  ].join('');
