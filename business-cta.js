(function(){
  ...
  style.textContent = [
    ...
    '#gg-business-cta .gg-biz-link{display:inline-flex;align-items:center;justify-content:center;background:#E8A93C;color:#0E3D22;text-decoration:none;font-size:12px;font-weight:800;border-radius:10px;padding:9px 12px;min-height:36px}',
    ...
    '@media(max-width:640px){#gg-business-cta{left:12px;right:12px;bottom:calc(12px + env(safe-area-inset-bottom));width:auto;border-radius:12px;padding:11px 12px 10px}#gg-business-cta .gg-biz-kicker{display:none}#gg-business-cta .gg-biz-title{font-size:16px;margin-bottom:8px}#gg-business-cta .gg-biz-copy{display:none}#gg-business-cta .gg-biz-muted{display:none}}'
  ].join('');
  ...
  banner.innerHTML =
    ...
    '<h2 class="gg-biz-title">¿Tu local ofrece sin gluten?</h2>' +
    '<p class="gg-biz-copy">Aparecé en el mapa y activá contacto directo con el plan Verificado.</p>' +
    '<div class="gg-biz-actions">' +
      '<a class="gg-biz-link" href="/negocios.html?ref=banner-flotante#planes">Ver planes</a>' +
