(function(){
  ...
  style.textContent = [
    ...
    '#gg-business-cta .gg-biz-link{display:inline-flex;align-items:center;justify-content:center;background:#E8A93C;color:#0E3D22;text-decoration:none;font-size:12px;font-weight:800;border-radius:10px;padding:9px 18px;min-height:36px;min-width:124px}',
